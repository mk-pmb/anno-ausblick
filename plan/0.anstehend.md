...
* Anno Server: Doku: Wie man Anno-Benutzernamen ändert.
  (E-Mail-Thread "Annotationen-Freischaltung" vom 2026-03-06 vormittags.)
* Bilder aus HeidIcon direkt in Annos darstellen können.
...
* Anno-Frontend: Diversen Ballast (z.B. Quill, XRX Legacy Fallback) als Plugins
  abkapseln, siehe auch Modularitäts-Antwort im FAQ.
...
* Frontend: Aus Worddatei kopierte Endnotenverlinkungen (Fußnoten) klickbar
  darstellen können (UBHD GitHub issue #1).
...
* FAQ: Warum DB nicht normalisiert? (Performance: Kein Zusmamensetzen nötig;
  einfacher im/export)
* FAQ: Warum Entwürfe nicht mit in der DB? (E-Mails "Anno-ID-URLs vorhersehbar
  machen" vom 2026-03-11)
* [liiive](https://github.com/rsimon/liiive):
  Kollaborativer Echtzeit-Anno-Editor im Browser, IIIF-basiert.
* Statistikabfrage für heiANNO (u.a. wie viele Annos in welchem Buch)
